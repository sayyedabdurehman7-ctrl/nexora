...
& $flet pack src\nexora\ui\app.py --name NEXORA --product-name NEXORA --product-version $appVersion `
...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'CHANGELOG-v1.0.1.txt') -Destination $dist -Force
