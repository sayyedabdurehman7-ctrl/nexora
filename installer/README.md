...
The finished installer is `installer\output\NEXORA-Setup.exe`. Send this single file to another Windows user. They double-click it, accept the default install folder, and use the NEXORA desktop shortcut. The app starts in Mock mode and does not require Python or Git.
