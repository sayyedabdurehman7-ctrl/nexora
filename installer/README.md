...
The finished tester installer is `installer\output\NEXORA-Setup-v0.3.0-Tester.exe`. Send this single file to another Windows user. They double-click it, accept the default install folder, and use the NEXORA desktop shortcut. The app starts in Demo mode and does not require Python, Git, or an API key.
